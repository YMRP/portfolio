...
import cv from '../assets/CV_Yostin-Ramos.pdf'  
  ...
  return (
    <div className="text-white flex flex-col gap-6 min-h-screen items-center justify-center ">
      ...
      <div className="flex gap-5 ">
        ...
        <a href={cv} download='CV_Yostin-Ramos.pdf' className="p-1 border-2 hover:border-amber-400 duration-200"> Download my CV</a>
